from tgen7_altitudinal_temperature import TerrainGenerator
...
altitude_adjusted_temperature = generator.adjust_temperature_for_elevation(elevation_map, temperature_map, lapse_rate=0.0135)
temperature_summer_map = generator.apply_seasonal_variation(altitude_adjusted_temperature, day_of_year=93, amplitude=20, days_in_year=365)
temperature_autumn_map = generator.apply_seasonal_variation(altitude_adjusted_temperature, day_of_year=187, amplitude=20, days_in_year=365)
temperature_winter_map = generator.apply_seasonal_variation(altitude_adjusted_temperature, day_of_year=280, amplitude=20, days_in_year=365)
temperature_spring2_map = generator.apply_seasonal_and_latitude_variation(altitude_adjusted_temperature, max_latitude=100, equator_position=100, day_of_year=0, amplitude=20, days_in_year=365, scaling_factor=0.1)
temperature_summer2_map = generator.apply_seasonal_and_latitude_variation(altitude_adjusted_temperature, max_latitude=100, equator_position=100, day_of_year=93, amplitude=20, days_in_year=365, scaling_factor=0.1)
temperature_autumn2_map = generator.apply_seasonal_and_latitude_variation(altitude_adjusted_temperature, max_latitude=100, equator_position=100, day_of_year=187, amplitude=20, days_in_year=365, scaling_factor=0.1)
temperature_winter2_map = generator.apply_seasonal_and_latitude_variation(altitude_adjusted_temperature, max_latitude=100, equator_position=100, day_of_year=280, amplitude=20, days_in_year=365, scaling_factor=0.1)
...
def on_key(event):
    if event.key == 'e':
        ...
        plot_data(altitude_adjusted_temperature, 'Temperature adjusted for elevation', cmap='coolwarm')
    elif event.key == '2':
